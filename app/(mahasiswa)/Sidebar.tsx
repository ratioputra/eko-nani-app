...
import { LayoutDashboard, GraduationCap, LogOut, BookMarked, FileSpreadsheet, FileText } from 'lucide-react'
...
export default function Sidebar({ profile, onLogout }: SidebarProps) {
  ...
  return (
    <aside className="w-64 border-r border-neutral-200 bg-white flex flex-col h-screen sticky top-0 shrink-0 font-sans">
      {/* Header */}
      <div className="px-6 py-5 border-b border-neutral-100 flex items-center gap-3">
        ...
        <div>
          <span className="font-bold text-base tracking-tight text-neutral-900 block">Portal Mahasiswa</span>
      ...
      <div className="p-4 border-t border-neutral-200 bg-neutral-50/50 flex flex-col gap-3">
        <div className="flex flex-col min-w-0 px-2 gap-0.5">
